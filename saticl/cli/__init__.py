...
from saticl.cli.click import clickify_default, clickify_type, get_multiple, get_show_default
...
def command(config: Type[BaseSettings], delimiter: str = ".", internal_delimiter: str = "__") -> Callable:
